...
void Escudo1() {
	...
	glVertex2i(0.68712, 6.25198); // C
	glVertex2i(2.3, 5.17058); // D
	glVertex2i(2.85733, 7); // E
	glVertex2i(1.6352, 7); // F
	glEnd();
...
void Escudo2() {
	...
	glVertex2i(4.11087, 9); // 
	glVertex2i(4.5, 9); // 
	glVertex2i(4.2411, 7.3612); // 
	glVertex2i(3.79676, 7.03007); // 
	glEnd();
...
void dibujar() {
	...
	glLoadIdentity();
	gluOrtho2D(0, 11.58, 0, 6.5); // tamaño de la img X(16) - Y(9)
...
int main(int argc, char* argv[]) {
	...
	glutInitWindowSize(899, 507); // Resolución de la IMG
