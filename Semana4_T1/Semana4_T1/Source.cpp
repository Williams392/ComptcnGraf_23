...
void display()
{
    ...
    glVertex2f(0, 100);        ///2nd Área de fuentes del segundo edificio
    glVertex2f(800, 100);
    ...
    glBegin(GL_LINES);// Barra superior de carretera
    glLineWidth(2);
    ...
    glBegin(GL_LINES);// Barra intermedia de carretera
    glLineWidth(2);
    glColor3f(1.0, 1.0, 1.0);
    glVertex2i(0, 62);
    glVertex2i(800, 62);
    ...
    glBegin(GL_LINES);// Barra inferior de carretera
    glLineWidth(2);
    glColor3f(1.0, 1.0, 1.0);
    glVertex2i(0, 39);
    glVertex2i(800, 39);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior1   ///
    glColor3ub(75, 35, 5);
    glVertex3f(680, 0, 0);
    glVertex3f(685, 0, 0);
    glVertex3f(685, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior2   ///
    glColor3ub(75, 35, 5);
    glVertex3f(580, 0, 0);
    glVertex3f(585, 0, 0);
    glVertex3f(585, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior3   ///
    glColor3ub(75, 35, 5);
    glVertex3f(480, 0, 0);
    glVertex3f(485, 0, 0);
    glVertex3f(485, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior4   ///
    glColor3ub(75, 35, 5);
    glVertex3f(380, 0, 0);
    glVertex3f(385, 0, 0);
    glVertex3f(385, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior5   ///
    glColor3ub(75, 35, 5);
    glVertex3f(280, 0, 0);
    glVertex3f(285, 0, 0);
    glVertex3f(285, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior6   ///
    glColor3ub(75, 35, 5);
    glVertex3f(180, 0, 0);
    glVertex3f(185, 0, 0);
    glVertex3f(185, 20, 0);
    ...
    glBegin(GL_TRIANGLE_FAN);  /// Árbol inferior7   ///
    glColor3ub(75, 35, 5);
    glVertex3f(80, 0, 0);
    glVertex3f(85, 0, 0);
    glVertex3f(85, 20, 0);
    ...
    glBegin(GL_QUADS);//tono gris+verde 1
    glColor3ub(0, 204, 0);
    glVertex3i(23, 40, 0);
    glVertex3i(21, 40, 0);
    glVertex3i(21, 46, 0);
    ...
    glBegin(GL_QUADS);//tono gris+verde 2
    glColor3ub(0, 204, 0);
    glVertex3f(6.5, 40, 0);
    glVertex3f(4.5, 40, 0);
    glVertex3f(4.5, 46, 0);
    ...
    glBegin(GL_QUADS);//rectángulo verde 1
    glColor3ub(0, 204, 0);
    glVertex3i(7, 40, 0);
    glVertex3i(9, 40, 0);
    glVertex3i(9, 43, 0);
    ...
    glEnd();
    //puerta izquierda//
    glBegin(GL_QUADS); //puerta principal
    ...
    glVertex3f(19, 33, 0);
    glEnd();
    glBegin(GL_LINES); //puerta principal línea 1
    glColor3ub(0, 0, 0);
    glVertex3f(19, 25, 0);
    glVertex3f(16, 25, 0);
    glEnd();
    glBegin(GL_LINES); //puerta principal línea 2
    glColor3ub(0, 0, 0);
    glVertex3f(16, 25, 0);
    glVertex3f(16, 33, 0);
    glEnd();
    ...
    ///...1er edificio principal parte-1
    glBegin(GL_QUADS);
    ...
    glBegin(GL_QUADS);
    glColor3ub(204, 204, 204);
    glVertex2f(90, 90);  //1er edificio 1er piso1
    glVertex2f(197, 90);
    glVertex2f(197, 145);
    glVertex2f(90, 145);
    glEnd();
    ...
    // Diseño del edificio principal....rojo y vidrio.......
    ...
    //....6th Diseño del sexto piso.........Puerta ventana
...
///white part///
    ...
    glVertex2f(401.5, 110);        /// Patio de comidas Parte derecha
    glVertex2f(437, 110);
    ...
    ///Food Court left part -> Patio de comidas parte izquierda
    glBegin(GL_QUADS);
    ...
    ///Fin del patio de comidas///

    ///....Árbol circular del lado derecho en el patio de comidas.....6 ///
    glColor3ub(139, 146, 22);
    circle(3, 6, 468, 101);
    glColor3ub(139, 146, 22);
    circle(5, 12, 463, 111);
    ...
    glColor3ub(227, 91, 137);         ///Completo.........Plaza de comidas.........comp.
    circle(1, 2, 468, 119);
    ...
    glVertex2f(480, 140);
    glEnd();
    ///Fin del árbol del círculo del lado derecho///
    ...
    glVertex2f(292, 140);
    glEnd();
    ///Fin del árbol del círculo del lado izquierdo///
    ...
    glBegin(GL_TRIANGLE_FAN);  ///árbol.........al lado del 3er edificio.......6  ///
    glColor3ub(75, 35, 5);
    glVertex2f(580, 90);
    glVertex2f(583, 90);
    glVertex2f(582, 100);
    ...
    glBegin(GL_QUADS);
    glColor3ub(43, 58, 139);
    glVertex2f(k + 10, 55);  //arriba.........parte inferior
    glVertex2f(k + 92, 55);
    glVertex2f(k + 92, 80);
    glVertex2f(k + 10, 80);
    glEnd();
